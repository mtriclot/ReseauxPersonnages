...
4. Une fois que c'est fait, il vous reste à indiquer le nom du fichier à traiter à la [ligne 77](https://github.com/mtriclot/Belfort/blob/master/PourEtudiants.R#L67) en remplacement de l'exemple ("2015.Seul_sur_Mars").
